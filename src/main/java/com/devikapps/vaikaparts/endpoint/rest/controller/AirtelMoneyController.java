...
public class AirtelMoneyController {
  ...
  @PostMapping
  public ResponseEntity<AirtelMoneyPayment> initiateAirtelMoneyPaymentPayment(
  ...
  public AirtelMoneyPayment getAirtelMoneyPayment(@PathVariable @NotNull String transactionId) {
    log.info(
  ...
  public Page<AirtelMoneyPayment> getAirtelMoneyPaymentsByCustomerMsisdn(
